...
// for sound 
    sf::SoundBuffer shootBuffer;     // Buffer for shoot sound
    sf::Sound shootSound;            // Sound object for shooting
    sf::SoundBuffer gameOverBuffer; // Buffer for game over sound
    sf::Sound gameOverSound;        // Sound object for game over sound
